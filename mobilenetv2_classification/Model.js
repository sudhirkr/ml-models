export default class mobilenetv2_classification {
    constructor() {    
	this.label = [
		'Amazon',
		'Axis Bank',
...
/*            let y_min = outputs[0].dataSync()[4 * ans] * image.height;
	...
	return new Promise( (resolve, reject) => {
		...
		console.log("Max Confidence: "+ max_confidence+", Index: "+max_confidence_index);
...
mobilenetv2_classification.dependencies = [
    "https://cdn.jsdelivr.net/npm/@tensorflow/tfjs@3.6.0/dist/tf.min.js",
]
mobilenetv2_classification.model = ROOT_DIR + "/mobilenetv2_classification/model/model.json"
