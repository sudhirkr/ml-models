export default class efficientnetb2Classification640 {
    constructor() {
        this.label = ['Amazon',
             'Axis Bank',
             'Bandhan Bank',
	...
	// Cast int32 to float32
    	...
    	/*const smallImg = await tf.image.resizeBilinear(tf_image, [640, 640]);
        tf_image = smallImg*/
...
efficientnetb2Classification640.dependencies = [
    "https://cdn.jsdelivr.net/npm/@tensorflow/tfjs@3.6.0/dist/tf.min.js",
]
efficientnetb2Classification640.model = ROOT_DIR + "/efficientnetb2Classification640/model/model.json"
